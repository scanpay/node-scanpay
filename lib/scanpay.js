    ...
    return {
        ...
        sync: {
            parsePing: (msg = '', signature = '', opts = {}) => {
                if (typeof msg !== 'string') throw new TypeError('1st argument is not a String');
                if (typeof signature !== 'string') throw new TypeError('2nd argument is not a String');
                if (!isObj(opts)) throw new TypeError('3rd argument is not an Object');
        ...
        ip: (str) => {
            switch (str) {
                case '35.156.139.106':  // charon
                case '35.156.183.10':   // charon-test
                case '52.58.246.210':   // dashboard
                case '35.156.147.104':  // dashboard-test
                    return true;
                default:
                    return false;
            }
